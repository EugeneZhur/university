            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel card hotel user-card">
                        ...
                        <p>Стоимость тура может изменяться в зависимости от выбора номера, типа пистания,
                            а также внешних факторов: например, акции в аэропорту и т.п. Для того, чтобы узнать точную стоимость тура и
                            приобрести его а Нашем турагенстве, закажите, пожалуйста БЕСПЛАТНЫЙ звонок для разговора с менеджером.</p>
