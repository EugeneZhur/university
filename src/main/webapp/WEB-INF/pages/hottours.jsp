        ...
        <main>
                ...
                <div class="filter-country col-lg-6">
                    <div class="uui-dropdown-button">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/hottours">По умолчанию</a></li>
                            <li><a href="/hottours/sort">Сперва дешевые</a></li>
                            <li><a href="/hottours/sortd">Сперва дорогие</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="row">
                <c:forEach items="${listTours}" var="tour">
                    <div class="col-lg-4">
                        <a href="/hottour/${tour.id}" class="panel-href">
